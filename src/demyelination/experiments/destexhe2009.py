...
def run(parameters, display=False, plot=True, save=True, load_inputs=False):
    ...
    # possion generator
    pg_th = nest.Create('poisson_generator', n=1, params={'rate': parameters.noise_pars.nuX_th, 'start' : 0., 'stop' : 2000.})
    ...
    pg_aone = nest.Create('poisson_generator', n=1, params={'rate': parameters.noise_pars.nuX_aone, 'start' : 0., 'stop' : 2000.})
