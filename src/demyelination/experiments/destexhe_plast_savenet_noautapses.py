...
def run(parameters, display=False, plot=True, save=True, load_inputs=False):
    ...
    nest.structural_plasticity_update_interval = 10 * 1000.
    ...
    with nest.RunManager():
        ...
        for total_time in np.arange(0, 300. * 1000, record_interval):
    ...
    store_net(topology_snn, rank, storage_paths['other'])
