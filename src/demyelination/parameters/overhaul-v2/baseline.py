...
An overhaul of the model by setting connections to zero, except for one. Redone in these set of files for new parameter config (e.g synaptic time const)
"""
...
def build_parameters(T, b):
    ...
    nuX_aone = 25.
    gamma_aone = 9.
    w_aone = 1.6 # epsp of 2.1 at -70mV. used to be 3. # epsp 0.26
