...
No connections except for the connection from the eA1 to the iA1 exist.
"""
...
def build_parameters(T):
    ...
    wMGN = 0. #2.2 # excitatory synaptic weight (mV)  - we keep this fixed now, but can change later on
    sigma_MGN = 0. #0.2
    sigma_TRN = 0. #0.2
    wX_TRN = 1.3
