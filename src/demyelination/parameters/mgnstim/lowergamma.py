...
There were significant oscillations in the CTX. So using the aone_adaptation.py file, a smaller gamma was found for the CTX and used in this file.
"""
...
experiment_label = 'nuxstim-lowera1gamma'
...
ParameterRange = {
        ...
        'scale_w' : np.arange(5., 13., 1.),
        'nuX_stim' : [13., 18., 23.]
        #'nuX_aone' : np.arange(15., 18.),
        #'gamma_aone' : np.arange(1., 4.)
}


################################
def build_parameters(w_th_stimscale, scale_w, nuX_stim):
    ...
    nuX_th = 20.
    #nuX_stim = 45.
    gamma_th = 20.   # relative inhibitory to excitatory synaptic weight - gamma
   ...
   # Excitatory synaptic elements of excitatory neurons
    ...
    epsilon_mgn_ctx = 0.026 * scale_eps # TODO look up literature ?
