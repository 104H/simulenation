...
The connection between the MGN and the e and iA1 are now separately defined.
"""
...
experiment_label = 'diff-mgntoctx-conn'
...
ParameterRange = {
        ...
        'nuX_aone' : [15., 16., 17.],
        'gamma_aone' : [2., 3.],
        'scale_ew' : np.arange(1., 11., 1.),
        'scale_iw' : np.arange(1., 11., 1.)
}


################################
def build_parameters(nuX_aone, gamma_aone, scale_ew, scale_iw):
    ...
    w_ctx_trn = 0.3
    w_ctx_mgn = 0.37
    w_mgn_ectx = 6. * scale_ew
    w_mgn_ictx = 6. * scale_iw
   ...
   # Excitatory synaptic elements of excitatory neurons
    ...
    return dict([('kernel_pars', kernel_pars),
                 ...
                 ('ctx_mgn_pars', {'conn' : conn_exc_mgn_ctx, 'syn' : syn_exc_mgn_ectx})
    ])
