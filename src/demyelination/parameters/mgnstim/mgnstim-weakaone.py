...
A different connection strength in the CTX to address oscillations.
"""
...
ParameterRange = {
        ...
        'nuX_aone' : [15., 20., 25., 30., 35.],
        'gamma_aone' : [13., 15., 17.],
        'w_aone' : np.arange(1., 6., 1.),
        'stim_dur' : [100., 200.]
}


################################
def build_parameters(nuX_aone, gamma_aone, w_aone, stim_dur):
    ...
    scale_w = 15. #4. # scale factor for MGN->CTX weight
