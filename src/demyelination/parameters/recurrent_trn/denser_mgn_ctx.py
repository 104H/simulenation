...
The weight of the connection from the MGN to the eA1 and iA1 are different here.
"""
...
experiment_label = 'recurr-trn-denser-mgn-ctx'
...
def build_parameters(nuX_stim, b, w_mgn_ectx):
   ...
   # Excitatory synaptic elements of excitatory neurons
    ...
    epsilon_mgn_ctx = 0.05 #0.026 # TODO look up literature ?
