...
experiment_label = 'aone_syntau_diffnoisew'
...
# ################################
ParameterRange = {
        'nuX_aone' : np.arange(1, 11, 1),
        'w_input_Eaone' : np.arange(1, 6, 1),
        'w_input_Iaone' : np.arange(1, 6, 1),
        'gamma_aone' : np.arange(2, 11, 2),
}


################################
def build_parameters(nuX_aone, w_input_Eaone, w_input_Iaone, gamma_aone):
    ...
    noise_pars = {
        ...
        'w_noise_Ectx' : w_input_Eaone,
        'w_noise_Ictx' : w_input_Iaone,
