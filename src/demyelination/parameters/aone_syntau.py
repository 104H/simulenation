...
This file only has the CTX and not the THL.
"""
import numpy as np
import sys
...
experiment_label = 'aone_syntau_ctxweight'
...
ParameterRange = {
        ...
        'w_input_aone' : np.arange(1, 6, 1),
        'gamma_aone' : np.arange(2, 17, 2),
        'w_aone' : np.arange(1, 4, 1)
}


################################
def build_parameters(nuX_aone, w_input_aone, gamma_aone, w_aone):
