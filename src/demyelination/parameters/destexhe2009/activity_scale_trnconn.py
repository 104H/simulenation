...
The connectivity from the TRN to the TRN has been reduced.
ALERT! scale_w_intratrn is a scale for epsilon NOT THE WEIGHT. The name of the variable is misleading.
"""
...
experiment_label = 'destexhe-weak-intratrn'
...
ParameterRange = {
    ...
    "w_exc" : [4., 5., 6.],
    "scale_w_intratrn" : np.arange(1., 5.) 
}

################################
def build_parameters(b, nu_x, w_exc, scale_w_intratrn):
   ...
   # Excitatory synaptic elements of excitatory neurons
    ...
    conn_intra_trn = {'allow_autapses': False, 'allow_multapses': False, 'rule': 'pairwise_bernoulli', 'p': scale_w_intratrn * epsilon_th}
