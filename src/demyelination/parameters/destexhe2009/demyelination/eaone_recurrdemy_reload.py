...
#experiment_label = 'eaone-noise-demy-reload-singlestim-start'
experiment_label = 'eaone-noise-demy-reload-start'
#experiment_label = 'mgn-to-eaone-reload-singlestim-end'
#experiment_label = 'mgn-to-eaone-reload-end'
...
def build_parameters(T):
    system_params = set_system_parameters(cluster=system_label, nodes=1, ppn=1, mem=128000, walltime='05-00:00:00', queue='hamstein')
    ...
    for eCa in eCa_levels:
        ...
        growth_curve_eaone_exc_axon.append({
            'growth_curve': g_curve,
            'growth_rate': 1 * gr_scaling,  # (elements/ms)
            'continuous': False,
            'eps': eCa,  # Ca2+
    ...
    growth_curves = {
        'growth_curve_eaone_exc_dendrite' : growth_curve_eaone_exc_dendrite,
                'growth_curve_eaone_exc_axon' : growth_curve_eaone_exc_axon,
                'growth_curve_mgn_axon' : growth_curve_mgn_axon,
                'growth_curve_parrot' : growth_curve_parrot
            }
    #'''
    ...
    conn_exc_aone_intra_eA1 = {'allow_autapses': False, 'allow_multapses': False, 'rule': 'pairwise_bernoulli', 'p': epsilon_aone * ctx_epsilon_decrease * 0.5}
    ...
    conn_exc_mgn_ctx = {'allow_autapses': False, 'allow_multapses': False, 'rule': 'pairwise_bernoulli', 'p': epsilon_mgn_ctx * 0.5}
