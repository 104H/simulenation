...
experiment_label = 'eaone-recurr-demy-rerun'
...
################################
def build_parameters(gr_scale, update_interval):
    np_seed = 1
    system_params = set_system_parameters(cluster=system_label, nodes=1, ppn=48, mem=32000, walltime='09:00:00', queue='hamstein')
