...
#experiment_label = '20pcdemy-15000s-eaone-doublerecurrgrowth-sbatch'
experiment_label = 'mpitest-4'
...
def build_parameters(disabled_conn_ratio, gr_scale, update_interval):
    np_seed = 1
    system_params = set_system_parameters(cluster=system_label, nodes=1, ppn=48, mem=128000, walltime='05-00:00:00', queue='hamstein')
