...
experiment_label = 'eaone-recurr-demy-onset'
...
def build_parameters(gr_scale, update_interval):
    np_seed = 1
    system_params = set_system_parameters(cluster=system_label, nodes=1, ppn=1, mem=128000, walltime='5:00:00', queue='hamstein')
