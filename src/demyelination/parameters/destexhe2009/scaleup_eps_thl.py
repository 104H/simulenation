...
In this experiment, we have increaed the inta Thalamic activity.
This experiment builds upon scaleup.py
"""
...
experiment_label = 'destexhe-scaleup-eps-thl'
...
################################
def build_parameters(b, nu_x, w_exc, epsilon_th, scale_eps_intratrn):
