...
The connectivity from the TRN to the TRN has been reduced from 8pc to 4pc.
The MGN and TRN were found to be oscillatory. This experiment implements heterogenous delays.
"""
...
experiment_label = 'destexhe-hetdelay'
