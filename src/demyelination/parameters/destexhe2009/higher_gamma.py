...
The activity in the MGN is higher than the TRN. A higher gamma for the Thalamus is explored here.
"""
...
experiment_label = 'destexhe-highergamma'
...
ParameterRange = {
    ...
    "gamma_th" : np.arange(10., 16.)
}

################################
def build_parameters(b, nu_x, w_exc, scale_eps_intratrn, gamma_th):
