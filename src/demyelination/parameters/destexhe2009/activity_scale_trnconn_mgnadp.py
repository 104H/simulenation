...
Applying adaptation to the MGN an in attemp to reduce oscillations in it.
...
experiment_label = 'destexhe-weak-intratrn-mgnadp'
...
################################
def build_parameters(b, b_mgn, nu_x, w_exc, scale_w_intratrn):
