...
The MGN has higher activity than the TRN.
In this experiment, we explore higher levels of gamma, a higher noise weight for the TRN and with weaker recurrent connections in the TRN.
...
experiment_label = 'destexhe-scaleup-thl-activity'
...
ParameterRange = {
    ...
    "b": [40., 20., 10., 5.],
    "nu_x": np.arange(2, 5, 2),
    "w_exc" : [4., 6.],
    "gamma_th" : np.arange(10, 14),
    "scale_eps_intratrn" : np.arange(1., 5.),
    "wX_TRN" : [1., 1.1, 1.2, 1.3, 1.4, 1.5, 2.]
}

################################
def build_parameters(b, nu_x, w_exc, gamma_th, scale_eps_intratrn, wX_TRN):
