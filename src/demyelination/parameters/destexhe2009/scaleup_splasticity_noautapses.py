...
#experiment_label = 'plasticity-debugging-noautapses-saveatonepsix-disableplast'
#experiment_label = 'plasticity-debugging-noautapses-eightypc'
#experiment_label = 'plasticity-debugging-noautapses-noadp'
experiment_label = 'plasticity-noautapses-6supdate'
#experiment_label = 'plasticity-debugging-sameparam'
