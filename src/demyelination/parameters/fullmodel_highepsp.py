...
experiment_label = 'nonhomg-eps-wgh'
...
ParameterRange = {
        #'T' : np.arange(0, 1., 1.),
        #'nuX_th' : np.arange(15., 21., 1.),
        #'wX_TRN' : np.arange(1.1, 1.5, .1),
        #'scale_w' : [1., 2., 3., 4.], # scale factor for MGN->CTX weight
        #'scale_eps' : [1., 2., 4.], # scale factor for MGN->CTX connection probability (epsilon)
        #'nuX_aone' : [15., 20., 25.]
        'nuX_th' : [20.],
        'wX_TRN' : [1.3],
...
################################
def build_parameters(nuX_th, wX_TRN, scale_w, scale_eps, nuX_aone):
