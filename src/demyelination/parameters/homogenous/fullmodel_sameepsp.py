...
# ################################
ParameterRange = {
        'alpha' : [0., 1., 3., 5., 7., 10., 13., 15., 18., 20.],
        'gamma_th' : [5., 10., 20.],
        'gamma_aone' : [5., 10.],
        'nuX_th' : [4., 7., 10., 14., 17., 20., 30., 35.]
}


################################
def build_parameters(alpha, gamma_th, gamma_aone, nuX_th):
    ...
    wMGN = .35 * alpha      # excitatory synaptic weight (mV)  - we keep this fixed now, but can change later on
    sigma_MGN = 0.2
    sigma_TRN = 0.2
    wX_TRN = 1.
    ...
    w_ctx_trn = 0.35 * alpha
    w_ctx_mgn = 0.35 * alpha
    w_mgn_ctx = 6. * alpha
